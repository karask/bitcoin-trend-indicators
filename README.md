...
- KK EMA Ribbon is daily-only and uses closing-price EMA 32/58 boundaries with hidden EMA 34/48 alignment: full descending length-order is bullish, full ascending order bearish, and mixed/equal values neutral. It is a separate indicator with 58-bar signal warmup, completed-close signals and next-open execution. The 14 September 2026 BTC/SOL screenshot boundaries match displayed rounding; ETH is a cross-feed approximation. The colour rule is provisional, and other assets are uncalibrated. See [calibration evidence](research/kk-smma-2026-09-15/REPORT.md).
