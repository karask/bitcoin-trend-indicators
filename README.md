...
- Presets are not performance-optimized against BTC, ETH, or SOL history. KK Supertrend is a fixed screenshot-calibrated comparison preset, and the other named presets remain fixed except for Super Guppy's explicitly exposed R1.2 inputs.
