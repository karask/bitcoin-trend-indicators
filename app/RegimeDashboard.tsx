...
export default function RegimeDashboard() {
  ...
  const triggerLabels = data?.selected.role === "exit" ? ["SHORT EXIT ABOVE", "LONG EXIT BELOW"] : data?.selected.role === "confirmation" ? ["POSITIVE ABOVE", "NEGATIVE BELOW"] : data?.selected.confirmation ? ["BULLISH CONFIRMATION ABOVE", "BEARISH CONFIRMATION BELOW"] : ["BULLISH ABOVE", "BEARISH BELOW"];
