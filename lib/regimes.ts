...
// September 14–22 daily references confirm 32/58 boundaries; 34/48 colour alignment remains provisional.
...
const BASE_INDICATOR_SPECS: Array<Omit<IndicatorSpec, "guidance">> = [
  ...
  { id: "kk_ema_ribbon", displayName: "KK EMA Ribbon", shortName: "KK EMA Ribbon", role: "regime", family: "smoothing/order", supportedTimeframes: ["1d", "1w"], parameters: { lengths: "32/34/48/58", boundaries: "32/58", source: "Close", calibrationDate: "2026-09-22", colourRule: "provisional alignment" }, thresholdKind: "conditional", description: "Closing-price EMA 32/58 ribbon with hidden 34/48 averages: gold for full bullish alignment, purple for bearish alignment, grey otherwise.", disclaimer: "September 14–22, 2026 daily screenshots: BTC, ETH, DOGE and SUI 32/58 boundaries match displayed rounding on the screenshot venue; JUP differs by one last decimal place on Bitstamp. SOL and RAY use cross-feed approximations. The 34/48 colour rule is provisional. Weekly uses the same lengths in weeks and is uncalibrated. Remaining assets are uncalibrated; this does not claim to reproduce a private formula." },
