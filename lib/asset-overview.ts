...
export function summarizeOverview(data: OverviewHistory, indicator: string) {
  ...
  const options = { market: data.lab === "crypto" ? "crypto" as const : data.lab === "stock" ? "equity" as const : "commodity" as const, asset: data.lab === "crypto" ? data.history.daily.asset : undefined, stock: data.lab === "stock" ? data.history.stock.id : undefined, indicatorIds: [indicator] };
